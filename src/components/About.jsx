...
function About(){
    return (
        <div>
            <h2>About Me</h2>
            <p>I’Hello! My name is Brittany and I enjoy creating things 
            ...
            <p>Fast-forward to today, and I’ve had the privilege of working at an 
            ...
            <p>I also recently launched a course that covers everything you need to build a 
